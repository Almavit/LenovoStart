...
public class DBFReader extends DBFBase implements Closeable {
	...
	public DBFReader(InputStream in, Charset charset, boolean showDeletedRows, boolean supportExtendedCharacterFields) {
		try {
			...
			com.linuxense.javadbf.DBFUtils.close(dataInputStream);
			com.linuxense.javadbf.DBFUtils.close(in);
			throw new com.linuxense.javadbf.DBFException(e.getMessage(), e);
		}
	}


	private Map<String, Integer> createMapFieldNames(com.linuxense.javadbf.DBFField[] fieldArray) {
